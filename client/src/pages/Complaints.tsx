...
const Complaints = () => {
  ...
  const closedComplaints = useMemo(() => filteredComplaints.filter((complaint) => isClosedComplaint(complaint.status)), [filteredComplaints]);
    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      <div className="mb-8">
        ...
        <p className="mt-4 text-lg leading-8 text-slate-600 dark:text-slate-300">
          Track how complaints move from submission to field work, resolution, or rejection while filtering by category, status, and location.
        </p>
      </div>
      ...
      <div className="grid gap-5 md:grid-cols-3">
        ...
        <StatsCard label="Closed Complaints" value={closedComplaints.length} tone="teal" description="Resolved and rejected complaints kept visible for transparency." />
      </div>
        ...
        <section>
          <div className="mb-5 flex items-end justify-between gap-4">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-bold text-slate-900 dark:text-slate-100">Resolved and rejected complaints published for public transparency</h2>
            </div>
