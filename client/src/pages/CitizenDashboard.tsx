...
const CitizenDashboard = () => {
  ...
  const totalRemarks = useMemo(
    () => complaints.reduce((t, c) => t + c.remarks.length, 0),
    [complaints],
  );
            ...
            >
              ...
              <div className="mt-5 border-t border-slate-200 pt-4 dark:border-slate-800">
                <RemarksPanel
                  ...
                  emptyMessage="No department remarks have been added yet."
                />
              </div>
              ...
              <div className="mt-4">
                ...
                {complaint.status === "In Progress" && (
                  <div className="rounded-xl border border-amber-200 bg-amber-50 p-4 text-sm dark:border-amber-900 dark:bg-amber-950/30">
                    ...
                    <p className="mt-1 text-slate-700 dark:text-slate-300">
                      Editing has been disabled while the issue is under review
                      or field work.
                    </p>
                  </div>
                )}
                ...
                {complaint.status === "Resolved" && (
                  <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-4 text-sm dark:border-emerald-900 dark:bg-emerald-950/30">
                    ...
                    <p className="mt-1 text-slate-700 dark:text-slate-300">
                      Check the department remarks above for resolution notes or
                      actions taken.
                    </p>
                  </div>
                )}
    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <h1 className="font-serif text-4xl font-bold leading-tight text-slate-900 dark:text-slate-100">
              Monitor and manage your civic complaints in one place
            </h1>

            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-slate-600 dark:text-slate-300">
              Civic Connect allows you to monitor every issue you report. Track
              complaint status, view official department remarks, and stay
              informed as municipal teams work toward resolving civic problems.
            </p>
          </div>
          ...
          <div className="rounded-xl bg-slate-50 px-5 py-4 text-sm text-slate-600 dark:bg-slate-800 dark:text-slate-300">
            ...
            <p className="mt-1">
              {complaints.length} total complaints submitted.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <StatsCard
          ...
          tone="orange"
          description="Complaints waiting for acknowledgement."
        />
        ...
        <StatsCard
          ...
          tone="blue"
          description="Issues currently under department work."
        />
        ...
        <StatsCard
          ...
          value={totalRemarks}
          tone="teal"
          description="Department remarks across complaints."
        />
      </div>
